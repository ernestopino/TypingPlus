...
package com.epinom.typingplus.objects
{
	/**
	 * @import
	 */
	...
	public class TPInterfaceObject
	{
		/**
		 * @property
		...
		/**
		  ...
		  */
		public function TPInterfaceObject(object:DisplayObject, className:String, instanceName:String, hashId:String, changeSize:Boolean, percentageWidth:Number, percentageHeight:Number, 
