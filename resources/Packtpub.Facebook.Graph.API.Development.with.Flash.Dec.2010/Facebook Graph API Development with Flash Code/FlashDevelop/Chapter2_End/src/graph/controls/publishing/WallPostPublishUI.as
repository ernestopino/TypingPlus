package graph.controls.publishing
{
	...
	public class WallPostPublishUI extends PublishUI
	{
		protected var _messageLabel:Label;
		protected var _messageInput:TextArea;
		
		public function WallPostPublishUI(a_parent:DisplayObjectContainer = null, a_xpos:Number = 0, a_ypos:Number = 0, a_ownerID:String = "", a_connectionType:String = "")
		{
